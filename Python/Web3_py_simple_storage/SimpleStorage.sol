...
contract SimpleStorage {
    ...
    */
    ...
    function retrieveView() public view returns(uint256){//PC: return type declaration comes at the end of the function declaration in solidity unlike in other programming languages like java and c++
